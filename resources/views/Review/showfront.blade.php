      ...
      <div class="col-md-12">
        <div id="product-tab">
          ...
          <ul class="tab-nav">
            ...
            <li class="active"><a data-toggle="tab" href="#tab1">Instagrame</a></li>
          </ul>
          <!-- /product tab nav -->
